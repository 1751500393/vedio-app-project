...
public interface CategoryDao {
     ...
     * @return 对象列表
     */
    List<Category> queryAllByLimit(@Param("cate") Category category, @Param("pageable") Pageable pageable);
     ...
     * 查询顶级类别
     */
    List<Category> selectByFirstLevel();
}
